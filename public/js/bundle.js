...
module.exports = RaspiApp = React.createClass({displayName: "RaspiApp",
  ...
  render: function() {
    return (
      React.createElement("div", {className: "raspi-app"}, 
        React.createElement("p", null, "Hello there ", this.state.foo)
      )
    );
  }
});
...
},{"../../components/RaspiApp.react":1,"react":157}]},{},[158]);
